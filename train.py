...
def main(_run, _config, _log):
    ...
    for sub_epoch in range(n_sub_epochs):
        ...
        for _, sample in enumerate(train_loader):
            ...
            query_pred, loss_wt_spt_1, loss_wt_qry_1, loss_wt_spt_2, loss_wt_qry_2  = model(support_images, support_fg_mask, query_images, query_labels, opt=optimizer, train=True)
            ...
            loss = query_loss + loss_wt_spt_1 + loss_wt_qry_1 + loss_wt_spt_2 + loss_wt_qry_2
